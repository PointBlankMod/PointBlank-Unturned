...
namespace UpdaterCore
{
    class Program
    {
        ...
        public static readonly string Unturned_Path = Directory.GetCurrentDirectory() + "/..";

        public static readonly string Modules_Path = Unturned_Path + "/Modules";
        ...
        public void Run()
        {
            ...
            {
                Console.WriteLine("Please make sure you have placed the folder containing the executable and files into your Unturned directory.");
