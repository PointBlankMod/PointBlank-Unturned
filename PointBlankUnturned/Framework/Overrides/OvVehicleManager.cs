...
{
	internal class OvVehicleManager
	{
        #region Reflection
        private static MethodInfo _miTellVehicleDestroy = PointBlankReflect.GetMethod<VehicleManager>("tellVehicleDestroy", BindingFlags.Instance | BindingFlags.Public);
        #endregion
        ...
        public void TellVehicleDestroy(CSteamID steamId, uint instanceId)
        {
            ...
            PointBlankDetourManager.CallOriginal(_miTellVehicleDestroy, VehicleManager.instance, steamId, instanceId);
        }
