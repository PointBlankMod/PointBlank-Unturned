...
{
    public class CommandPlayer : PointBlankCommand
    {
        #region Properties
        ...
        private void Permissions(PointBlankPlayer executor, string[] args)
        {
            ...
            UnturnedChat.SendMessage(executor, string.Join(",", ply.Permissions.Select(a => a.Permission).ToArray()), ConsoleColor.Green);
        }
